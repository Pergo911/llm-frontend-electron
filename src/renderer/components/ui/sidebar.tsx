    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
          size="sm"
          className={`${className}, hover:bg-background-acrylic-hover hover:text-foreground`}
          onClick={(event) => {
            onClick?.(event);
            toggleSidebar();
          }}
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-xl p-2 text-left text-sm outline-none ring-primary transition-[width,height,padding] hover:bg-background-acrylic-hover hover:text-foreground focus-visible:ring-2 active:bg-background-acrylic-hover active:text-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-background-acrylic-hover data-[active=true]:font-medium data-[active=true]:text-foreground data-[state=open]:hover:bg-background-acrylic-hover data-[state=open]:hover:text-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'hover:bg-background-acrylic-hover hover:text-foreground',
        outline:
          'bg-background shadow-[0_0_0_1px_var(--border)] hover:bg-background-acrylic-hover hover:text-foreground hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]',
      },
      size: {
        default: 'h-8 text-sm',
        sm: 'h-7 text-xs',
