      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <div className="absolute top-0 left-0 w-full h-[64px] leading-[64px] text-xs italic font-bold text-muted-foreground text-center border-sidebar-border border-b">
              Drag window here...
            </div>
